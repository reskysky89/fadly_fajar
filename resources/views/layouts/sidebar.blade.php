    ...
    <nav class="mt-4 flex-1 overflow-y-auto">
        ...
        @if (Auth::user()->role_user == 'admin')
            ...
            <a href="{{ route('pesanan.index') }}" 
                ...
                @if($countPending > 0)
                    <span class="ml-auto bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $countPending }}</span>
                @endif
            </a>
